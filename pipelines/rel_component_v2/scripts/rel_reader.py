...
from scripts.rel_pipeline import make_relation_extractor

# make the config work
from scripts.rel_model import create_relation_model, create_classification_layer


@spacy.registry.readers("rel_gold_corpus.v1")
